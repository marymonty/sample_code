...
# applyCallback function calls our createCrowd func with the user inputs      
def applyCallback( pHeadField, pBodyField, pLegField, pNumMember, *pArgs ):
    ...
    print("number of members: %s" %(numMembers) )
    # create the crowd
    createCrowd( selectedHead-1, selectedBody-1, selectedFeet-1, numMembers )
